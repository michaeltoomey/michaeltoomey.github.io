...
data = conditions.ConditionContainer(cond_metadata, saved_data_file='processed_DE_data/mig1vsWT_comparisons.txt', node_data_to_append='data_files/cytoscape_info_edges.json', edge_data_to_append='data_files/YGL035C_cytoscape_info_nodes.json')
...
data = conditions.ConditionContainer(cond_metadata, saved_data_file='processed_DE_data/mig2vsWT_comparisons.txt', node_data_to_append='data_files/cytoscape_info_edges.json', edge_data_to_append='data_files/YGL209W_cytoscape_info_nodes.json')
